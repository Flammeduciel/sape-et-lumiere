const FESTIVAL = {
  ...
  artists: [
    { name: "Kévin Mavungu", discipline: "Chant, Afrobeat", category: "musique", image: "assets/images/artists/musique_1.jpg", bio: "Figure montante de l'afrobeat congolais, Kévin Mavungu mêle rythmes traditionnels et sonorités urbaines. Ses textes en lingala et français racontent la jeunesse de Brazzaville.", social: { instagram: "#", youtube: "#", spotify: "#" } },
    { name: "Maya Nsimba", discipline: "Chant, Soul & R&B", category: "musique", image: "assets/images/artists/musique_2.jpeg", bio: "Voix veloutée de la scène soul brazzavilloise, Maya Nsimba revisite les standards avec une touche afro-futuriste. Son premier EP 'Éclats' a marqué 2024.", social: { instagram: "#", youtube: "#", spotify: "#" } },
    { name: "Darel Kossa", discipline: "DJ, Afro-house", category: "musique", image: "assets/images/artists/musique_3.jpeg", bio: "Maître des dancefloors de la capitale, Darel Kossa fusionne afro-house, amapiano et ndombolo. Ses sets sont des voyages rythmiques sans frontière.", social: { instagram: "#", soundcloud: "#", mixcloud: "#" } },
    { name: "Léna Mpassi", discipline: "Stylisme, Haute couture", category: "mode", image: "assets/images/artists/sapeur_1.jpg", bio: "Créatrice de la maison 'Mpassi Atelier', Léna habille l'élite sapeuse avec des pièces uniques alliant tissus traditionnels (liputa, ngwala) et coupes contemporaines.", social: { instagram: "#", website: "#" } },
    { name: "Chris Banzouzi", discipline: "Stylisme, Sape", category: "mode", image: "assets/images/artists/sapeur_2.jpeg", bio: "Ambassadeur de la sape moderne, Chris Banzouzi signe des tenues où le tailoring italien rencontre l'audace congolaise. Ses costumes racontent l'histoire d'un peuple élégant.", social: { instagram: "#", website: "#" } },
    { name: "Noah Makosso", discipline: "Design vestimentaire", category: "mode", image: "assets/images/artists/sapeur_3.jpeg", bio: "Designer pluridisciplinaire, Noah Makosso explore les matières recyclées et le upcycling textile. Ses collections 'Renaissance' transforment les chutes en œuvres portables.", social: { instagram: "#", behance: "#" } },
    { name: "Élodie Ngalula", discipline: "Installation lumineuse", category: "art", image: "assets/images/artists/lumiere_1.jpg", bio: "Artiste lumière formée à l'École des Beaux-Arts de Kinshasa, Élodie crée des environnements immersifs où la lumière sculpte l'espace. Son travail questionne la perception.", social: { instagram: "#", website: "#" } },
    { name: "Marc Elonga", discipline: "Art numérique", category: "art", image: "assets/images/artists/lumiere_2.jpg", bio: "Pionnier du digital art en Afrique centrale, Marc Elonga code des génératifs visuels projetés sur l'architecture urbaine. Ses algorithmes dansent au rythme du ndombolo.", social: { instagram: "#", github: "#", website: "#" } },
    { name: "Sarah Mouzinga", discipline: "Sculpture lumineuse", category: "art", image: "assets/images/artists/lumiere_3.jpg", bio: "Sculptrice de lumière, Sarah Mouzinga travaille le néon, la fibre optique et le verre. Ses installations 'Âmes brillantes' illuminent les nuits de Brazzaville depuis 2022.", social: { instagram: "#", website: "#" } }
  ],
