...
const contactsPublicRoutes = require('./routes/contacts-public');
...
app.use('/api/contacts', contactsPublicRoutes(db));
app.use('/api/admin/contacts', authMiddleware, contactsRoutes(db));
